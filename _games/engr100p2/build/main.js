...
var $author$project$Main$initModel = {audiorepo: _List_Nil, currentData: $author$project$Scenes$SceneSettings$NullSceneData, currentGlobalData: $author$project$Common$initGlobalData, currentScene: $author$project$Scenes$SceneSettings$nullSceneT, time: 0, transition: $elm$core$Maybe$Nothing};
	...
	function (_v0, initData) {
		if ((initData.$ === 'GCIdData') && (initData.b.$ === 'GCStoryAnimationInitData')) {
			return _Utils_update(
				...
				{
					gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCStoryAnimationModel($author$project$SceneProtos$CoreEngine$GameComponents$StoryAnimation$Base$nullModel)
				});
		} else {
	...
	function (env, d) {
		...
		return function (_v0) {
			...
			A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$enter, env.globalData.keyList)) ? _Utils_Tuple3(
				nd,
				_List_fromArray(
					[
				...
				env) : ((omodel.t === 600) ? _Utils_Tuple3(
				nd,
				_List_fromArray(
					[
						_Utils_Tuple2(
				...
				env) : ((omodel.t === 1200) ? _Utils_Tuple3(
				nd,
				_List_fromArray(
					[
						_Utils_Tuple2(
				...
				env) : ((omodel.t >= 1599) ? _Utils_Tuple3(
				nd,
				_List_fromArray(
					[
						_Utils_Tuple2($author$project$SceneProtos$CoreEngine$GameComponent$Base$GCParent, $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCInitStartMenuMsg),
		...
		return A2(
			...
			(omodel.t >= 1500) ? _List_fromArray(
				...
				[
					...
					3)
				]) : (((omodel.t >= 400) && (omodel.t <= 700)) ? _List_fromArray(
				[
					_Utils_Tuple2(
					A6(
					...
					3)
				]) : (((omodel.t >= 700) && (omodel.t <= 1000)) ? _List_fromArray(
				[
					_Utils_Tuple2(
					A6(
						$author$project$Lib$Render$Text$renderTextWithColorCenter,
						...
						_Utils_Tuple2(960, 300)),
					3)
				]) : (((omodel.t >= 1000) && (omodel.t <= 1500)) ? _List_fromArray(
				[
					_Utils_Tuple2(
					A6(
						$author$project$Lib$Render$Text$renderTextWithColorCenter,
...
var $cometia0$messenger_core$Messenger$GeneralModel$GeneralModel = F5(
...
var $author$project$SceneProtos$CoreEngine$Camera$Base$nullCamera = {
	...
	size: _Utils_Tuple2($author$project$SceneProtos$CoreEngine$Camera$Config$cameraWidth, $author$project$SceneProtos$CoreEngine$Camera$Config$cameraHeight),
	velocity: _Utils_Tuple2(0, 0)
};
...
var $author$project$SceneProtos$CoreEngine$LayerBase$nullCommonData = {buff: _List_Nil, camera: $author$project$SceneProtos$CoreEngine$Camera$Base$nullCamera, coin: 200, inputState: $author$project$SceneProtos$CoreEngine$LayerBase$Other, instruction: 0, showUI: false, tileMap: $author$project$SceneProtos$CoreEngine$LayerBase$testTileMap};
	...
	function (env, d) {
		...
		if (_v0.$ === 'Tick') {
			...
			if (_v1.$ === 'Alive') {
				...
				var newBullet = (!omodel.delay) ? _Utils_update(
					d,
					{
						position: _Utils_Tuple2(
							d.position.a + $elm$core$Basics$round(d.velocity.a),
							d.position.b + $elm$core$Basics$round(d.velocity.b))
					}) : _Utils_update(
					d,
					{
						gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCBulletModel(
									...
									return function (lifeStatus) {
										return function (gcModel) {
											return function (extra) {
												return {acceleration: acceleration, extra: extra, gcModel: gcModel, hitbox: hitbox, hp: hp, lifeStatus: lifeStatus, mass: mass, position: position, simpleCheck: simpleCheck, size: size, uid: uid, velocity: velocity};
											};
										};
									};
								};
		...
		if ((initData.$ === 'GCIdData') && (initData.b.$ === 'GCChipInitData')) {
			...
			if (_v1.$ === 'Coin') {
				return $author$project$SceneProtos$CoreEngine$GameComponent$Base$Data(id)(
					_Utils_Tuple2(25, 25))(chipI.position)(
					...
					$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCChipModel(
						_Utils_update(
							...
							{tp: chipI.tp})))($author$project$SceneProtos$CoreEngine$GameComponents$Chip$Model$initExtraData);
			} else {
				return $author$project$SceneProtos$CoreEngine$GameComponent$Base$Data(id)(
					_Utils_Tuple2(50, 50))(chipI.position)(
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Chip$Model$updateDeadVel = function (_v0) {
	...
	var _v1 = _Utils_Tuple2(
		...
		_Utils_update(
			...
			{
				position: _Utils_Tuple2(
					d.position.a + $elm$core$Basics$round(nvel.a),
					d.position.b + $elm$core$Basics$round(nvel.b)),
				velocity: nvel
			}));
	var newenv = _v1.a;
	var newdata = _v1.b;
	...
	function (env, initData) {
		if ((initData.$ === 'GCIdData') && (initData.b.$ === 'GCEnderInitData')) {
			...
			return _Utils_update(
				$author$project$SceneProtos$CoreEngine$GameComponent$Base$nullData,
				{
					gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCEnderModel(
						{stTime: env.t, tp: p.tp})
				});
		} else {
			return $author$project$SceneProtos$CoreEngine$GameComponent$Base$nullData;
		}
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Ender$Model$updateModel = F2(
	function (env, d) {
		...
		return (_Utils_cmp(env.t, tt + 1500) < 0) ? _Utils_Tuple3(d, _List_Nil, env) : _Utils_Tuple3(
			d,
			_List_fromArray(
				[
								...
								_Utils_update(
									$author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$nullModel,
									{
										...
										dir: (!A2(
											$author$project$Lib$Tools$RNG$genRandomInt,
											seed,
											_Utils_Tuple2(0, 1))) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right,
										maxHp: 9.99,
										searchSpeed: 3,
										typeId: typeId
									})),
	...
	function (env, initData) {
		if ((initData.$ === 'GCIdData') && (initData.b.$ === 'GCEnemyInitData')) {
			...
			return A3(
				...
				env.t,
				d.typeId,
				$author$project$SceneProtos$CoreEngine$GameComponent$Base$Data(id)(d.size)(d.position)(
					_Utils_Tuple2(0, 0))(
					_Utils_Tuple2(0, $author$project$MainConfig$gravity))(mass)(
					_List_fromArray(
						[$author$project$SceneProtos$CoreEngine$GameComponent$Base$nullBox]))(
		...
		var _v0 = function () {
			...
			if (_v1.$ === 'EnemyShot') {
				...
				if (_Utils_eq(model.chasingState, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Chase)) {
					var shotIntervalPossible = (_Utils_cmp(env.t - model.lastAtkTime, model.atkInterval) > 0) || ((st === 3) && (A2(
						$author$project$Lib$Tools$RNG$genRandomInt,
						(env.t * d.uid) + 114514,
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Model$updateDir = function (_v0) {
	...
	var pposx = _v1.a;
	var pposy = _v1.b;
	var _v2 = _Utils_Tuple2(((d.position.a / $author$project$MainConfig$tileSize) | 0) + nxtTile, (d.position.b / $author$project$MainConfig$tileSize) | 0);
	var nposx = _v2.a;
	var nposy = _v2.b;
	...
	var isFacingWall = function (t) {
		...
		A2(
			$elm$core$Maybe$withDefault,
			1,
			A3($tortus$elm_array_2d$Array2D$get, nposx, nposy, tileMap))) && (_Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? (A2($elm$core$Basics$modBy, $author$project$MainConfig$tileSize, d.position.a) >= 32) : (A2($elm$core$Basics$modBy, $author$project$MainConfig$tileSize, d.position.a) <= 32));
	var _v3 = A3($elm$core$Tuple$mapBoth, $elm$core$Basics$toFloat, $elm$core$Basics$toFloat, d.position);
	var eposx = _v3.a;
	var eposy = _v3.b;
	var ndir = function () {
		...
		if (_v5.$ === 'EnemyShot') {
			...
			switch (_v6.$) {
				...
				case 'Search':
					...
					return isChange ? (_Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) : odir;
				default:
					if (!st) {
						return (_Utils_cmp(
							pposx,
							eposx + (omodel.chaseSense + A2(
								$author$project$Lib$Tools$RNG$genRandomInt,
								(env.t * d.uid) * 2,
								_Utils_Tuple2(-10, 10)))) > 0) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right : ((_Utils_cmp(
							pposx,
							eposx - (omodel.chaseSense + A2(
								$author$project$Lib$Tools$RNG$genRandomInt,
								(env.t * d.uid) * 2,
								_Utils_Tuple2(-10, 10)))) < 0) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left : odir);
					} else {
						if (st === 1) {
							...
							var peleft = _Utils_cmp(
								...
								eposx - (omodel.chaseSense + A2(
									...
									(env.t * d.uid) * 2,
									_Utils_Tuple2(-10, 10)))) < 0;
							var isChange = (((env.t - omodel.lastTurnTime) > 60) && ((_Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left) && peright) || (_Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) && peleft))) || (isFacingWall || isFacingCliff);
							return isChange ? (_Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) : odir;
						} else {
							if (st === 2) {
								var peright = _Utils_cmp(
								...
								var peleft = _Utils_cmp(
									...
									eposx - (omodel.chaseSense + A2(
										...
										(env.t * d.uid) * 2,
										_Utils_Tuple2(-10, 10)))) < 0;
								var isChange = (((env.t - omodel.lastTurnTime) > 60) && ((_Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left) && peright) || (_Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) && peleft))) || isFacingWall;
								return isChange ? (_Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) : odir;
							} else {
								return odir;
							}
			...
			switch (_v7.$) {
				case 'Await':
					return odir;
				case 'Search':
					return (isFacingWall || isFacingCliff) ? (_Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) : odir;
				default:
					var peright = _Utils_cmp(
						pposx,
						eposx + (omodel.chaseSense + A2(
					...
					var peleft = _Utils_cmp(
						...
						eposx - (omodel.chaseSense + A2(
							...
							(env.t * d.uid) * 2,
							_Utils_Tuple2(-10, 10)))) < 0;
					var isChange = (((env.t - omodel.lastTurnTime) > 180) && ((_Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left) && peright) || (_Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) && peleft))) || (isFacingWall || isFacingCliff);
					return isChange ? (_Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Left : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) : odir;
			}
		}
	}();
		...
		_Utils_update(
			d,
			{
				gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCEnemyModel(
					_Utils_update(
						omodel,
						{dir: ndir, lastTurnTime: nTurnTime}))
			}),
		_List_Nil,
		env);
	var nd = _v4.a;
		...
		if (_v2.$ === 'EnemyShot') {
				...
				function () {
					if (st !== 2) {
						...
						switch (_v3.$) {
							...
							case 'Search':
								return _Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? _Utils_Tuple2(omodel.searchSpeed, nvel.b) : _Utils_Tuple2(-omodel.searchSpeed, nvel.b);
							default:
								return _Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? _Utils_Tuple2(omodel.chaseSpeed, nvel.b) : _Utils_Tuple2(-omodel.chaseSpeed, nvel.b);
						}
					} else {
			...
			switch (_v6.$) {
				case 'Await':
					return _Utils_Tuple2(0, nvel.b);
				case 'Search':
					return ((env.t - omodel.lastTurnTime) > 90) ? (_Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? _Utils_Tuple2(omodel.searchSpeed, nvel.b) : _Utils_Tuple2(-omodel.searchSpeed, nvel.b)) : _Utils_Tuple2(0, nvel.b);
				default:
					return ((env.t - omodel.lastTurnTime) > 90) ? (_Utils_eq(odir, $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Right) ? _Utils_Tuple2(omodel.chaseSpeed, nvel.b) : _Utils_Tuple2(-omodel.chaseSpeed, nvel.b)) : _Utils_Tuple2(0, nvel.b);
			}
		}
	}();
	var _v1 = (!_Utils_eq(
								...
								return _List_fromArray(
									[
										...
										$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCNewChipMsg(
											{
												position: d.position,
												tp: $author$project$SceneProtos$CoreEngine$GameComponents$Chip$Base$Chip($author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$DoubleTrigger)
											}))
									]);
							case 2:
								return _List_fromArray(
									[
										...
										$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCNewChipMsg(
											{
												position: d.position,
												tp: $author$project$SceneProtos$CoreEngine$GameComponents$Chip$Base$Chip($author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Scatter)
											}))
									]);
							case 3:
								return _List_fromArray(
									[
										...
										$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCNewChipMsg(
											{
												position: d.position,
												tp: $author$project$SceneProtos$CoreEngine$GameComponents$Chip$Base$Chip($author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Splash)
											}))
									]);
							default:
								return _List_Nil;
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Model$updateChasingState = F2(
	function (pos, _v0) {
		...
		var nChasingState = function () {
			...
			switch (_v4.$) {
				case 'Await':
					return (!isFarAway) ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Search : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Await;
				case 'Search':
					return isFarAway ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Await : (isNear ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Chase : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Search);
				default:
					return isFarAway ? $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Await : $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Base$Chase;
			}
		}();
		...
		switch (gcmsg.$) {
			...
			case 'GCHitByBulletMsg':
				...
				if (gcModel.$ === 'GCBulletModel') {
					...
					return function (_v2) {
						...
						(nhp <= 0) ? (_Utils_eq(d.lifeStatus, $author$project$SceneProtos$CoreEngine$GameComponent$Base$Alive) ? _Utils_Tuple3(
							_Utils_update(
								d,
								{
									hp: nhp,
			...
			case 'GCHitByWeaponMsg':
				...
				if (gcModel.$ === 'GCWeaponModel') {
					...
					return (_Utils_cmp(env.t - emodel.lastHitByTime, judgeHitByTime) > -1) ? function (_v4) {
						var dd = _v4.a;
						var ll = _v4.b;
						var ee = _v4.c;
						return _Utils_Tuple3(
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Enemy$Display$debug = F2(
	function (env, d) {
		...
		var posx = _v0.a;
		var posy = _v0.b;
		var _v1 = _Utils_Tuple2(((d.position.a / $author$project$MainConfig$tileSize) | 0) + nxtTile, (d.position.b / $author$project$MainConfig$tileSize) | 0);
		var nposx = _v1.a;
		var nposy = _v1.b;
		var isFacingWall = function (t) {
			return A2($elm$core$Basics$modBy, 2, t) === 1;
						...
						A2(
							...
							_List_fromArray(
								[
									...
									A3($avh4$elm_color$Color$rgb255, 200, 46, 55))
								]),
							_List_fromArray(
								[hpShow])),
					...
					gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCGameMapModel(
						{
							...
							mapGenState: $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$Loading($author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$GenBlueprint),
...
var $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Model$genBlueprint = function (_v0) {
	...
	var seed0 = $author$project$Lib$Tools$RNG$seed(
		$elm$time$Time$posixToMillis(env.globalData.currentTimeStamp));
	...
	return _Utils_Tuple2(
		...
		_Utils_update(
			...
			{
				blueprint: nbp2,
				mapGenState: $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$Loading($author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$GenRooms),
				storeRoom: stores
			}));
};
...
var $tortus$elm_array_2d$Array2D$getColumn = F2(
	function (column, array2d) {
		return A3(
			...
			column,
			$elm$core$Array$empty,
			$elm$core$Array$toList(array2d.data));
	});
...
var $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Model$genRoom = function (_v0) {
	...
	var _v1 = A2(
		...
		bp.rooms,
		_Utils_ap(bp.pathList, model.storeRoom));
	var smallest = _v1.a;
	var tl = _v1.b;
	var br = _v1.c;
	var initMap = A2(
	...
	var spawn = A2(
		$elm$core$Maybe$withDefault,
		$author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Room$nullRoom,
		A3($tortus$elm_array_2d$Array2D$get, startInSmallest.a, startInSmallest.b, initMap)).spawnPoint;
	...
	return _Utils_Tuple2(
		...
		_Utils_update(
			...
			{
				map: initMap,
				mapGenState: $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$Loading($author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$GenTileMap),
...
var $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Model$genTileMap = function (_v0) {
	...
	return _Utils_Tuple2(
		...
		_Utils_update(
			model,
			{
				mapGenState: $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$Loading($author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$GenPlayer)
			}));
};
...
var $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Model$genTrans = function (_v0) {
	...
	return _Utils_Tuple2(
		_Utils_Tuple2(
			...
			_Utils_update(
				model,
				{mapGenState: $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$Loaded, mapTransPoint: trans, storeTransPoint: storeTrans})),
		msg);
};
						...
						return _Utils_Tuple2(
							_Utils_Tuple2(
								...
								_Utils_update(
									omodel,
									{
										mapGenState: $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$Loading($author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$GenEnemy)
									})),
							_List_fromArray(
								[
									_Utils_Tuple2(
						...
						return _Utils_Tuple2(
							_Utils_Tuple2(
								...
								_Utils_update(
									omodel,
									{
										mapGenState: $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$Loading($author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Base$GenStore)
									})),
	...
	function (env, msg, d) {
		...
		if (msg.$ === 'GCPlayerPositionMsg') {
			...
			var msg2 = A2(
				...
				F2(
					function (i, t) {
						return (_Utils_eq(env.commonData.inputState, $author$project$SceneProtos$CoreEngine$LayerBase$Other) && ((A2($author$project$Lib$Coordinate$Coordinates$dist, t, p) <= 150) && A2(
							$elm$core$Maybe$withDefault,
							false,
							A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$key_r, env.globalData.keyList)))) ? _Utils_Tuple2(
							...
							$author$project$SceneProtos$CoreEngine$GameComponent$Base$Transfer(
								A2(
									$elm$core$Maybe$withDefault,
									_Utils_Tuple2(0, 0),
									A2($elm_community$list_extra$List$Extra$getAt, i, model.mapTransPoint)))) : _Utils_Tuple2(
							$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCByName('Player'),
						...
						return (_Utils_eq(env.commonData.inputState, $author$project$SceneProtos$CoreEngine$LayerBase$Other) && ((A2($author$project$Lib$Coordinate$Coordinates$dist, t, p) <= 150) && A2(
							...
							$author$project$SceneProtos$CoreEngine$GameComponent$Base$Transfer(
								A2(
									$elm$core$Maybe$withDefault,
									_Utils_Tuple2(0, 0),
									A2($elm_community$list_extra$List$Extra$getAt, i, model.storeTransPoint)))) : _Utils_Tuple2(
							$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCByName('Player'),
							$author$project$SceneProtos$CoreEngine$GameComponent$Base$NullGCMsg);
					}),
				model.mapTransPoint);
...
var $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Display$displayInstruction = F2(
	function (env, d) {
		var omodel = function () {
			var _v0 = d.gcModel;
			if (_v0.$ === 'GCGameMapModel') {
		...
		return (!_Utils_eq(
			...
			_Utils_Tuple2(48, 48),
			'key_r') : $linsyking$elm_canvas$Canvas$empty;
	});
...
var $author$project$SceneProtos$CoreEngine$GameComponents$PauseMenu$Model$updateModel = F2(
	function (env, d) {
		...
		var _v1 = A2(
			$elm$core$Maybe$withDefault,
			false,
			A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$escape, env.globalData.keyList)) ? _Utils_Tuple2(
			_List_fromArray(
				[
					_Utils_Tuple2($author$project$SceneProtos$CoreEngine$GameComponent$Base$GCParent, $author$project$SceneProtos$CoreEngine$GameComponent$Base$ResumeMsg)
				]),
...
var $author$project$SceneProtos$CoreEngine$GameComponents$PauseMenu$Model$displayPauseMenuAsRect = F2(
	function (env, d) {
		...
		var idre = A3(
			...
			_Utils_Tuple2(resumeX, resumeY),
			model.buttonSize) ? 'button_resume_1' : 'button_resume_0';
		var idqt = A3(
			$author$project$Lib$Coordinate$Coordinates$judgeMouseRect,
			env.globalData.mousePos,
			_Utils_Tuple2(quitX, quitY),
			model.buttonSize) ? 'button_quit_1' : 'button_quit_0';
		return A2(
			$linsyking$elm_canvas$Canvas$group,
			_List_fromArray(
				[
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$initBoundKey = {jump: $author$project$Lib$Tools$KeyCode$key_w, jump2: $author$project$Lib$Tools$KeyCode$space, left: $author$project$Lib$Tools$KeyCode$key_a, right: $author$project$Lib$Tools$KeyCode$key_d};
var $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$nullModel = {boundKey: $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$initBoundKey, dir: $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Right, maxHp: 200, motionState: $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Normal, movementState: $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Idle, positionState: $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$InAir};
var $author$project$SceneProtos$CoreEngine$GameComponents$Player$Model$initModel = F2(
	function (_v0, initData) {
		if ((initData.$ === 'GCIdData') && (initData.b.$ === 'GCPlayerInitData')) {
			...
			var d = initData.b.a;
			var hp = 200;
			return $author$project$SceneProtos$CoreEngine$GameComponent$Base$Data(id)(d.size)(d.pozition)(
				_Utils_Tuple2(0, 0))(
				...
				$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCPlayerModel(
					_Utils_update(
						...
						{maxHp: hp})))($author$project$SceneProtos$CoreEngine$GameComponents$Player$Model$initExtraData);
		} else {
			return $author$project$SceneProtos$CoreEngine$GameComponent$Base$nullData;
		}
	});
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Player$State$changeState = function (_v0) {
	...
	var changeDir = function (dir) {
		return A2(
			$elm$core$Maybe$withDefault,
			false,
			A2($elm$core$Array$get, bk.right, kl)) ? $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Right : (A2(
			$elm$core$Maybe$withDefault,
			false,
			A2($elm$core$Array$get, bk.left, kl)) ? $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Left : dir);
	};
	var _v1 = function () {
		if (opstate.$ === 'OnGround') {
			return ((_Utils_eq(omstate, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Idle) || ($author$project$SceneProtos$CoreEngine$GameComponents$Player$State$isWalking(omstate) || $author$project$SceneProtos$CoreEngine$GameComponents$Player$State$isLandingBuffer(omstate))) && (A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, bk.right, kl)) && A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, bk.left, kl)))) ? ((A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, bk.jump, kl)) || A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, bk.jump2, kl))) ? _Utils_Tuple2(
				_Utils_Tuple3(
				...
				_Utils_Tuple3($author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Idle, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$OnGround, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Normal),
				odir)) : (((_Utils_eq(omstate, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Idle) || ($author$project$SceneProtos$CoreEngine$GameComponents$Player$State$isLandingBuffer(omstate) || ($author$project$SceneProtos$CoreEngine$GameComponents$Player$State$isWalking(omstate) && _Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Left)))) && A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, bk.right, kl))) ? ((A2(
				$elm$core$Maybe$withDefault,
				...
				_Utils_Tuple3(
					...
					$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$InAir,
					$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Normal),
				$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Right) : _Utils_Tuple2(
				_Utils_Tuple3(
					...
					$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Normal),
				$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Right)) : (((_Utils_eq(omstate, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Idle) || ($author$project$SceneProtos$CoreEngine$GameComponents$Player$State$isLandingBuffer(omstate) || ($author$project$SceneProtos$CoreEngine$GameComponents$Player$State$isWalking(omstate) && _Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Right)))) && A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, bk.left, kl))) ? ((A2(
				$elm$core$Maybe$withDefault,
				...
				_Utils_Tuple3(
					...
					$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$InAir,
					$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Normal),
				$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Left) : _Utils_Tuple2(
				_Utils_Tuple3(
					$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Walking(0),
					$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$OnGround,
					$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Normal),
				$author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Left)) : (((_Utils_eq(omstate, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Idle) || ($author$project$SceneProtos$CoreEngine$GameComponents$Player$State$isWalking(omstate) || $author$project$SceneProtos$CoreEngine$GameComponents$Player$State$isLandingBuffer(omstate))) && (A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, bk.jump, kl)) || A2(
				$elm$core$Maybe$withDefault,
				...
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, bk.left, kl)))) ? _Utils_Tuple2(
				_Utils_Tuple3(
				...
				globalData: _Utils_update(
					gd,
					{
						keyList: A3(
							...
							bk.jump2,
							false,
							A3($elm$core$Array$set, bk.jump, false, env.globalData.keyList))
					})
			}) : env;
	}();
	return _Utils_Tuple3(
		_Utils_update(
			d,
			{
				gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCPlayerModel(
					_Utils_update(
						omodel,
						{dir: ndir, motionState: nmotion, movementState: nmstate, positionState: npstate}))
			}),
		ls,
		nenv);
};
		...
		_Utils_update(
			d,
			{
				gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCPlayerModel(
					_Utils_update(
						omodel,
						{positionState: $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$OnGround}))
			}),
		ls,
		env) : _Utils_Tuple3(
		_Utils_update(
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Player$Model$updateVel = function (_v0) {
	...
	var kl = env.globalData.keyList;
	var bk = omodel.boundKey;
	var nvel2 = _Utils_eq(omodel.movementState, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Idle) ? _Utils_Tuple2(0, nvel.b) : ((A2(
		$elm$core$Maybe$withDefault,
		false,
		A2($elm$core$Array$get, bk.right, kl)) && A2(
		$elm$core$Maybe$withDefault,
		false,
		A2($elm$core$Array$get, bk.left, kl))) ? _Utils_Tuple2(0, nvel.b) : ((_Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Right) && A2(
		$elm$core$Maybe$withDefault,
		false,
		A2($elm$core$Array$get, bk.right, kl))) ? _Utils_Tuple2(nspeed, nvel.b) : ((_Utils_eq(omodel.dir, $author$project$SceneProtos$CoreEngine$GameComponents$Player$Base$Left) && A2(
		$elm$core$Maybe$withDefault,
		false,
		A2($elm$core$Array$get, bk.left, kl))) ? _Utils_Tuple2(-nspeed, nvel.b) : _Utils_Tuple2(0, nvel.b))));
	...
	function (env, d) {
		...
		if (_v0.$ === 'Alive') {
			...
			var _v4 = A2(
				$elm$core$Maybe$withDefault,
				false,
				A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$key_e, env.globalData.keyList)) ? _Utils_Tuple2(
				_List_fromArray(
					[
						_Utils_Tuple2(
						$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCParent,
		...
		switch (gcmsg.$) {
			case 'GCHitByBulletMsg':
				...
				if (gcModel.$ === 'GCBulletModel') {
					var bullet = gcModel.a;
					var nhp = d.hp - bullet.atk;
					return ((nhp <= 0) && _Utils_eq(d.lifeStatus, $author$project$SceneProtos$CoreEngine$GameComponent$Base$Alive)) ? _Utils_Tuple3(
						_Utils_update(
							d,
							{
								hp: nhp,
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Player$Display$displayHP = F2(
	function (env, d) {
		...
		var rt = A2(
			$elm$core$Basics$min,
			1,
			A2($elm$core$Basics$max, 0, d.hp / omodel.maxHp));
		return _List_fromArray(
			[
				A2(
				$linsyking$elm_canvas$Canvas$group,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$linsyking$elm_canvas$Canvas$Settings$fill(
								A3($avh4$elm_color$Color$rgb255, 220, 103, 109)),
						...
						_List_fromArray(
							[
								...
								$author$project$Lib$Render$Shape$rect,
								env.globalData,
								_Utils_Tuple2(40 + (28 * 4), 40 + (10 * 4)),
								_Utils_Tuple2(83 * 4, 4 * 4))
							])),
						A2(
						$linsyking$elm_canvas$Canvas$shapes,
						_List_fromArray(
		...
		var alv = function () {
			...
			if (_v2.$ === 'Alive') {
				...
				return A2(
					$elm$core$Basics$min,
					1,
					A2($elm$core$Basics$max, 0, 1 - (dt / 250)));
			}
		}();
		var _v0 = A2($author$project$SceneProtos$CoreEngine$Camera$Camera$posInCam, env, d.position);
		var x_ = _v0.a;
		...
		return A2(
			...
			A2(
				...
				_Utils_ap(
					...
					env.commonData.showUI ? _Utils_ap(
		...
		var _v0 = gd.mouseDownAct ? (A3(
			...
			_List_fromArray(
				[
					...
					_Utils_Tuple2($author$project$SceneProtos$CoreEngine$GameComponent$Base$GCParent, $author$project$SceneProtos$CoreEngine$GameComponent$Base$DisplayInstructionMsg)
				]),
			function (e) {
				return _Utils_update(
					e,
...
var $author$project$SceneProtos$CoreEngine$GameComponents$StarterMenu$Model$displayStarterMenuAsRect = F2(
	function (env, d) {
		...
		var rulesID = A3(
			...
			env.globalData.mousePos,
			_Utils_Tuple2(rulesX, rulesY),
			model.buttonSize) ? 'button_rules_1' : 'button_rules_0';
		var startX = model.startPos.a - (model.buttonSize.a / 2);
		var startY = model.startPos.b - (model.buttonSize.b / 2);
		var startID = A3(
			$author$project$Lib$Coordinate$Coordinates$judgeMouseRect,
			env.globalData.mousePos,
			_Utils_Tuple2(startX, startY),
			model.buttonSize) ? 'button_start_1' : 'button_start_0';
		return A2(
			$linsyking$elm_canvas$Canvas$group,
			_List_fromArray(
				[
	...
	function (env, t) {
		...
		var potionList = A2(
			...
			function (i) {
				switch (i) {
					case 1:
						return A2($author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$Potion, 20, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$SmallHealthPotion);
					case 2:
						return A2($author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$Potion, 40, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$MediumHealthPotion);
					case 3:
						return A2($author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$Potion, 80, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$LargeHealthPotion);
					case 4:
						return A2($author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$Potion, 30, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$SpeedPotion);
					case 5:
						return A2($author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$Potion, 40, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$AtkPotion);
					default:
						return A2($author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$Potion, 30, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Potion$SpeedPotion);
				}
			},
		...
		return $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCStoreModel(
			A3(
				...
				items,
				_List_fromArray(
					[$author$project$SceneProtos$CoreEngine$GameComponents$Store$Base$Selling, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Base$Selling, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Base$Selling]),
				0));
	});
var $author$project$SceneProtos$CoreEngine$GameComponents$Store$Model$initModel = F2(
	function (env, initData) {
		if ((initData.$ === 'GCIdData') && (initData.b.$ === 'GCStoreInitData')) {
			...
			var d = initData.b.a;
			return $author$project$SceneProtos$CoreEngine$GameComponent$Base$Data(id)(
				_Utils_Tuple2(8 * $author$project$MainConfig$tileSize, 6 * $author$project$MainConfig$tileSize))(d.position)(
				_Utils_Tuple2(0, 0))(
				_Utils_Tuple2(0, 1))(1)(
				_List_fromArray(
					[
		...
		var _v0 = function () {
			...
			if (!_v2) {
				...
				return (_Utils_eq(
					...
					$author$project$SceneProtos$CoreEngine$GameComponents$Store$Base$Selling) && A2(
					$elm$core$Maybe$withDefault,
					false,
					A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$key_r, env.globalData.keyList))) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							itemStates: A3($elm_community$list_extra$List$Extra$setAt, i - 1, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Base$Bought, model.itemStates)
						}),
					A2(
						...
						A2(
							...
							A2($elm_community$list_extra$List$Extra$getAt, i - 1, model.items)))) : _Utils_Tuple2(
					model,
					_Utils_Tuple2(_List_Nil, env));
			}
		}();
		...
		var nmodel = function () {
			if (cmsg.$ === 'GCPlayerPositionMsg') {
				...
				var near = (A2(
					...
					pos,
					_Utils_Tuple2(d.position.a - (3 * $author$project$MainConfig$tileSize), d.position.b + (2 * $author$project$MainConfig$tileSize))) <= 90) ? 1 : ((A2(
					$author$project$Lib$Coordinate$Coordinates$dist,
					pos,
					_Utils_Tuple2(d.position.a, d.position.b + (2 * $author$project$MainConfig$tileSize))) <= 90) ? 2 : ((A2(
					$author$project$Lib$Coordinate$Coordinates$dist,
					pos,
					_Utils_Tuple2(d.position.a + (3 * $author$project$MainConfig$tileSize), d.position.b + (2 * $author$project$MainConfig$tileSize))) <= 90) ? 3 : 0));
				return _Utils_update(
					omodel,
					{near: near});
			} else {
			...
			if ((_v1.a.$ === 'PotionItem') && (_v1.b.$ === 'Selling')) {
				...
				switch (_v3.$) {
					case 'SmallHealthPotion':
						return _Utils_Tuple3(
							'Small Health Potion',
							$elm$core$String$fromInt(potion.price) + '$    (press R to buy)',
							'Heal 10 HP');
					case 'MediumHealthPotion':
						return _Utils_Tuple3(
			...
			_Utils_eq(cur, $author$project$SceneProtos$CoreEngine$GameComponents$Store$Base$NullItem) ? _List_Nil : _List_fromArray(
				[
					...
					A2(
						$author$project$SceneProtos$CoreEngine$Camera$Camera$posInCam,
						env,
						_Utils_Tuple2((d.position.a - (4 * $author$project$MainConfig$tileSize)) + 40, (d.position.b - (3 * $author$project$MainConfig$tileSize)) + 30))),
					A6(
					$author$project$Lib$Render$Text$renderTextWithColor,
					env.globalData,
					30,
					...
					A2(
						$author$project$SceneProtos$CoreEngine$Camera$Camera$posInCam,
						env,
						_Utils_Tuple2((d.position.a - (4 * $author$project$MainConfig$tileSize)) + 40, (d.position.b - (2 * $author$project$MainConfig$tileSize)) + 20))),
					A6(
					$author$project$Lib$Render$Text$renderTextWithColor,
					env.globalData,
					30,
...
var $author$project$SceneProtos$CoreEngine$GameComponents$StoreMenu$Model$initModel = F2(
	function (_v0, initData) {
		if ((initData.$ === 'GCIdData') && (initData.b.$ === 'GCStoreMenuInitData')) {
			var id = initData.a;
			var d = initData.b.a;
			return $author$project$SceneProtos$CoreEngine$GameComponent$Base$Data(id)(d.size)(d.position)(
				_Utils_Tuple2(0, 0))(
				_Utils_Tuple2(0, 1))(1)(
				_List_fromArray(
					[
...
var $author$project$SceneProtos$CoreEngine$GameComponents$StoreMenu$Model$updateModel = F2(
	function (env, d) {
		...
		var _v2 = A2(
			$elm$core$Maybe$withDefault,
			false,
			A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$key_c, env.globalData.keyListPre)) ? _Utils_Tuple2(
			_List_Nil,
			_Utils_update(
				d,
				{
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3($author$project$Lib$Render$Shape$rect, env.globalData, camPos, camSize)
						])),
			...
			return $author$project$SceneProtos$CoreEngine$GameComponent$Base$Data(id)(
				...
				$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCUpgradeMenuModel(
					_Utils_update(
						...
						{hp: d.hp, installedChip: d.installedChip, installingChip: d.installingChip})))($author$project$SceneProtos$CoreEngine$GameComponents$UpgradeMenu$Model$initExtraData);
		} else {
			return $author$project$SceneProtos$CoreEngine$GameComponent$Base$nullData;
		}
	});
...
var $author$project$SceneProtos$CoreEngine$GameComponents$UpgradeMenu$Model$updateState = function (_v0) {
	...
	if (_v1.$ === 'Moving') {
		...
		var toPos = def(
			$elm$core$List$head(
				A2($elm$core$List$drop, to - 1, model.chipPos)));
		var rate = 1 / 6;
		var frPos = def(
			$elm$core$List$head(
				A2($elm$core$List$drop, fr - 1, model.chipPos)));
		return (A2(
									...
									wmodel,
									{
										installedChip: _Utils_ap(
											...
											_Utils_ap(
												...
												A2($elm$core$List$drop, to - 3, model.installedChip))),
										installingChip: defc(
											$elm$core$List$head(
												A2($elm$core$List$drop, to - 4, model.installedChip)))
									}))
						});
				} else {
					return dd;
							...
							dd,
							{
								gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCUpgradeMenuModel(
									_Utils_update(
										wmodel,
										{
											movingState: (to >= 4) ? $author$project$SceneProtos$CoreEngine$GameComponents$UpgradeMenu$Base$Stopped(fr) : $author$project$SceneProtos$CoreEngine$GameComponents$UpgradeMenu$Base$Stopped(to)
										}))
							});
					} else {
						return dd;
		...
		return A2(
			$elm$core$Maybe$withDefault,
			false,
			A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$key_a, env.globalData.keyList)) ? _Utils_Tuple3(
			function (dd) {
				return _Utils_update(
					dd,
					{
									...
									movingState: $author$project$SceneProtos$CoreEngine$GameComponents$UpgradeMenu$Base$Moving(
										_Utils_Tuple3(
											...
											_Utils_Tuple3(
												...
												def(
													$elm$core$List$head(
														A2($elm$core$List$drop, cur - 1, model.chipPos))).a,
												def(
													$elm$core$List$head(
														A2($elm$core$List$drop, cur - 1, model.chipPos))).b),
											_Utils_Tuple3(
												defc(
													$elm$core$List$head(
														A2($elm$core$List$drop, cur - 1, model.installedChip))),
												def(
													$elm$core$List$head(
														A2($elm$core$List$drop, (cur + 3) - 1, model.chipPos))).a,
												def(
													$elm$core$List$head(
														A2($elm$core$List$drop, (cur + 3) - 1, model.chipPos))).b)))
								}))
					});
			}(d),
			omsg,
			...
			$elm$core$Maybe$withDefault,
			false,
			A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$key_d, env.globalData.keyList)) ? _Utils_Tuple3(
			function (dd) {
				return _Utils_update(
					dd,
					{
			...
			$elm$core$Maybe$withDefault,
			false,
			A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$key_w, env.globalData.keyList)) && (cur >= 2)) ? _Utils_Tuple3(
			function (dd) {
				return _Utils_update(
					dd,
					{
									...
									movingState: $author$project$SceneProtos$CoreEngine$GameComponents$UpgradeMenu$Base$Moving(
										_Utils_Tuple3(
											...
											_Utils_Tuple3(
												...
												def(
													$elm$core$List$head(
														A2($elm$core$List$drop, (cur - 1) - 1, model.chipPos))).a,
												def(
													$elm$core$List$head(
														A2($elm$core$List$drop, (cur - 1) - 1, model.chipPos))).b)))
								}))
					});
			}(d),
			omsg,
			...
			$elm$core$Maybe$withDefault,
			false,
			A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$key_s, env.globalData.keyList)) && (cur <= 2)) ? _Utils_Tuple3(
			function (dd) {
				return _Utils_update(
					dd,
					{
...
var $author$project$SceneProtos$CoreEngine$GameComponents$UpgradeMenu$Model$updateModel = F2(
	function (env, d) {
		...
		var gd = env.globalData;
		var _v0 = gd.mouseDownAct ? (A3($author$project$Lib$Coordinate$Coordinates$judgeMouseRect, gd.mousePos, model.resumePos, model.resumeSize) ? _Utils_Tuple2(
			_List_fromArray(
				[
					_Utils_Tuple2($author$project$SceneProtos$CoreEngine$GameComponent$Base$GCParent, $author$project$SceneProtos$CoreEngine$GameComponent$Base$ResumeMsg)
				]),
...
var $author$project$SceneProtos$CoreEngine$GameComponents$UpgradeMenu$Model$renderInstalling = F2(
	function (env, d) {
		...
		if (_v0.$ === 'Stopped') {
			var t = _v0.a;
			return (!_Utils_eq(model.installingChip, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$NoUpgrade)) ? _List_fromArray(
				[
					A5(
					$author$project$Lib$Render$Sprite$renderSprite,
					env.globalData,
					...
					def(
						$elm$core$List$head(
							A2($elm$core$List$drop, t - 1, model.chipPos))),
					model.chipSize,
			...
			var p2y = _v4.c;
			return _Utils_ap(
				(!_Utils_eq(s1, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$NoUpgrade)) ? _List_fromArray(
					[
						A5(
						$author$project$Lib$Render$Sprite$renderSprite,
						env.globalData,
	...
	function (env, d) {
		...
		return _List_fromArray(
			[
				...
				A6($author$project$Lib$Render$Text$renderTextWithColor, env.globalData, 32, 'Speed Potion', 'disposabledroid_bbregular', $avh4$elm_color$Color$white, model.speedBuffTextPos),
				A6(
				$author$project$Lib$Render$Text$renderTextWithColor,
				env.globalData,
				32,
				...
				A6($author$project$Lib$Render$Text$renderTextWithColor, env.globalData, 32, 'Damege Potion', 'disposabledroid_bbregular', $avh4$elm_color$Color$white, model.atkBuffTextPos),
				A6(
				$author$project$Lib$Render$Text$renderTextWithColor,
				env.globalData,
				32,
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Model = F9(
	function (dir, angle, atk, atkInterval, lastAtkTime, lastHitTime, atkType, weaponUpgrade, boundKey) {
		return {angle: angle, atk: atk, atkInterval: atkInterval, atkType: atkType, boundKey: boundKey, dir: dir, lastAtkTime: lastAtkTime, lastHitTime: lastHitTime, weaponUpgrade: weaponUpgrade};
	});
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$nullModel = A9(
	...
	A2(
		...
		2,
		_List_fromArray(
			[$author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$NoUpgrade, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$NoUpgrade, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$NoUpgrade])),
	...
	function (_v0, initData) {
		if ((initData.$ === 'GCIdData') && (initData.b.$ === 'GCWeaponInitData')) {
			...
			var gcWeaponNullModelWithAtkI = _Utils_update(
				...
				{atkInterval: d.atkInterval, atkType: d.atkType});
			return $author$project$SceneProtos$CoreEngine$GameComponent$Base$Data(id)(d.size)(d.position)(
				_Utils_Tuple2(0, 0))(
				...
				A2(
					$author$project$SceneProtos$CoreEngine$GameComponent$Base$Box,
					_Utils_Tuple2(0, 0),
					d.size))(100)($author$project$SceneProtos$CoreEngine$GameComponent$Base$Alive)(
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Model$fireBullet = F4(
	function (env, fltPosition, mapPos, up) {
		...
		var nBullet3 = A2(
			$elm$core$List$map,
			function (bi) {
				return A2($elm$core$List$member, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Splash, up.upgrades) ? _Utils_update(
					bi,
					{
...
var $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Model$updateSwitch = function (_v0) {
	...
	var edMsg = ((A2(count, omodel.weaponUpgrade.upgrades, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$DoubleTrigger) >= 1) && ((A2(count, omodel.weaponUpgrade.upgrades, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Scatter) >= 1) && ((A2(count, omodel.weaponUpgrade.upgrades, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Splash) >= 1) && (($elm$core$List$length(
		A2(
			$elm$core$List$filter,
			function (a) {
				if (a.$ === 'IncreaseDamage') {
			...
			env.commonData.buff)) >= 1) && ($elm$core$List$length(
		A2(
			$elm$core$List$filter,
			function (a) {
				if (a.$ === 'SpeedUp') {
			...
			env.commonData.buff)) >= 1))))) ? _List_fromArray(
		[
	...
	var _v1 = A2(
		$elm$core$Maybe$withDefault,
		false,
		A2($elm$core$Array$get, bk._switch, kl)) ? _Utils_Tuple2(
		_Utils_eq(omodel.atkType, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Shooter) ? _Utils_update(
			d,
			{
				gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCWeaponModel(
					_Utils_update(
						omodel,
						{atkInterval: 20, atkType: $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Saber})),
				simpleCheck: A2(
					$author$project$SceneProtos$CoreEngine$GameComponent$Base$Box,
					_Utils_Tuple2(0, 0),
			...
			d,
			{
				gcModel: $author$project$SceneProtos$CoreEngine$GameComponent$Base$GCWeaponModel(
					_Utils_update(
						omodel,
						{atkInterval: 15, atkType: $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Shooter})),
	...
	function (env, d) {
		...
		var _v0 = function () {
			...
			if (_v1.$ === 'Shooter') {
				...
				return (_Utils_cmp(env.t - omodel.lastAtkTime, (omodel.atkInterval / 2) | 0) > 0) ? A3($author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Model$gcModelAngleUpdate, env, d, pos) : A2($author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Model$saberAngleUpdate, env, d);
			}
		}();
		var nd = _v0.a;
		var nenv = _v0.b;
		...
		var _v2 = function () {
			if (gd.mouseDownAct) {
				...
				var fltPosition = _Utils_Tuple2(d.position.a, d.position.b);
				return shotIntervalPossible ? (_Utils_eq(model.atkType, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Shooter) ? _Utils_Tuple2(
...
var $author$project$SceneProtos$CoreEngine$GameLayer$Model$searchNearestChip = function (objs) {
	...
	var _v4 = A2(
		...
		A2(
			$elm$core$List$partition,
			function (chip) {
				return A3($author$project$SceneProtos$CoreEngine$GameLayer$Model$isInCircle, playerPos, $author$project$MainConfig$tileSize * 1.5, chip.data.position);
			},
			chips));
	var hitChips = _v4.a;
		...
		if (_Utils_eq(env.globalData.state, $author$project$Base$Paused)) {
			...
			switch (msg.$) {
				case 'GCStoryMapMsg':
					...
					var nc = _Utils_update(
						oc,
						{tileMap: $author$project$SceneProtos$CoreEngine$GameComponents$GameMap$Room$storyRoom});
					return _Utils_Tuple3(
						model,
						_List_Nil,
						_Utils_update(
				...
				case 'DestroyTileMap':
					...
					var nc = _Utils_update(
						oc,
						{tileMap: $tortus$elm_array_2d$Array2D$empty});
					return _Utils_Tuple3(
						model,
						_List_Nil,
						_Utils_update(
				...
				case 'GCSplashMsg':
					...
					var nEnemies = A2(
						...
						function (enemy) {
							...
							var hp = d.hp;
							var nhp = hp - 3;
							var ndata = (nhp <= 0) ? (_Utils_eq(d.lifeStatus, $author$project$SceneProtos$CoreEngine$GameComponent$Base$Alive) ? _Utils_update(
								d,
								{
									hp: nhp,
									lifeStatus: $author$project$SceneProtos$CoreEngine$GameComponent$Base$Dead(0)
...
var $author$project$SceneProtos$CoreEngine$Camera$Camera$removeOutOfBound = F2(
	function (env, ls) {
		return (env.commonData.showUI ? $elm$core$List$filter(
			function (p) {
				return (p.name !== 'Enemy') || function () {
					...
					return !A2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							1,
							A3($tortus$elm_array_2d$Array2D$get, tx, ty, env.commonData.tileMap)));
				}();
			}) : function (x) {
			return x;
		})(
...
var $author$project$SceneProtos$CoreEngine$Camera$Camera$updateCameraSize = function (_v0) {
	...
	var ncam = A2(
		$elm$core$Maybe$withDefault,
		false,
		A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$shift, kl)) ? (((_Utils_cmp(ocam.size.a, $author$project$SceneProtos$CoreEngine$Camera$Config$cameraWidth * maxs) < 0) && (_Utils_cmp(ocam.size.b, $author$project$SceneProtos$CoreEngine$Camera$Config$cameraHeight * maxs) < 0)) ? _Utils_update(
		ocam,
		{
		...
		ocam,
		{
			size: _Utils_Tuple2($author$project$SceneProtos$CoreEngine$Camera$Config$cameraWidth * maxs, $author$project$SceneProtos$CoreEngine$Camera$Config$cameraHeight * maxs)
		})) : (((_Utils_cmp(ocam.size.a, $author$project$SceneProtos$CoreEngine$Camera$Config$cameraWidth + 32) < 0) && (_Utils_cmp(ocam.size.b, $author$project$SceneProtos$CoreEngine$Camera$Config$cameraHeight + 18) < 0)) ? _Utils_update(
		ocam,
		{
			size: _Utils_Tuple2($author$project$SceneProtos$CoreEngine$Camera$Config$cameraWidth, $author$project$SceneProtos$CoreEngine$Camera$Config$cameraHeight)
		}) : _Utils_update(
	...
	var ncam = function () {
		...
		if (_v1.$ === 'Shaking') {
			...
			return (!i) ? _Utils_update(
				ocam,
				{cameraState: $author$project$SceneProtos$CoreEngine$Camera$Base$Normal}) : _Utils_update(
				ocam,
				{
...
var $author$project$SceneProtos$CoreEngine$Camera$Camera$updateCamera = function (_v0) {
	...
	var playerPos = $author$project$SceneProtos$CoreEngine$GameComponent$Handler$getGCPos(
		$author$project$SceneProtos$CoreEngine$GameComponent$Handler$getGCByName(
			_Utils_Tuple2(model.objects, 'Player')));
	var c = env.commonData;
	var ocam = c.camera;
	return (A2($author$project$SceneProtos$CoreEngine$Camera$Camera$dist, ocam.position, playerPos) <= 3) ? $author$project$SceneProtos$CoreEngine$Camera$Camera$updateCameraState(
...
var $author$project$SceneProtos$CoreEngine$GameLayer$Model$updateCoin = F2(
	function (env, objs) {
		...
		var _v4 = A2(
			$elm$core$List$partition,
			function (coin) {
				return A3($author$project$SceneProtos$CoreEngine$GameLayer$Model$isInCircle, playerPos, $author$project$MainConfig$tileSize, coin.data.position);
			},
			coins);
		var hitCoins = _v4.a;
		...
		var _v5 = A2(
			$elm$core$List$partition,
			function (coin) {
				return A3($author$project$SceneProtos$CoreEngine$GameLayer$Model$isInCircle, playerPos, $author$project$MainConfig$tileSize * 3, coin.data.position);
			},
			noHitCoins);
		var nearCoins = _v5.a;
		var farCoins = _v5.b;
				...
				function (bulletLine) {
					return A2(
						...
						A2(
							$elm$core$List$map,
							function (enemyLine) {
								return A4($author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkIntersectSegSeg, bulletLine.st, bulletLine.en, enemyLine.st, enemyLine.en);
							},
							enemyLineList));
				},
				bulletLineList));
					...
					F2(
						function (enemy, _v0) {
							...
							return (isFirst && $author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkCollisionBulletEnemy(
								_Utils_Tuple3(env, bullet.data, enemy.data))) ? _Utils_Tuple2(
								_Utils_ap(
									_List_fromArray(
										[
											_Utils_Tuple2(
		...
		return A2(
			...
			function (bullet) {
				return $author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkCollisionBulletGamemap(
					_Utils_Tuple2(env, bullet.data)) ? _List_fromArray(
					[
						_Utils_Tuple2(
						$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCById(bullet.data.uid),
					...
					F2(
						function (player, _v0) {
							...
							return (isFirst && $author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkCollisionBulletPlayer(
								_Utils_Tuple3(env, bullet.data, player.data))) ? _Utils_Tuple2(
								_Utils_ap(
									_List_fromArray(
										[
											_Utils_Tuple2(
					...
					F2(
						function (weapon, cls) {
							return $author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkCollisionBulletWeapon(
								_Utils_Tuple3(env, bullet.data, weapon.data)) ? _Utils_ap(
								_List_fromArray(
									[
										_Utils_Tuple2(
										$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCById(bullet.data.uid),
			...
			function (enemyLine) {
				return A2(
					...
					A2(
						$elm$core$List$map,
						function (playerLine) {
							return A4($author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkIntersectSegSeg, enemyLine.st, enemyLine.en, playerLine.st, playerLine.en);
						},
						playerLineList));
			},
			enemyLineList));
					...
					F2(
						function (player, _v0) {
							...
							return (isFirst && $author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkCollisionEnemyPlayer(
								_Utils_Tuple3(env, enemy.data, player.data))) ? _Utils_Tuple2(
								_Utils_ap(
									_List_fromArray(
										[
											_Utils_Tuple2(
			...
			function (enemyLine) {
				return A2(
					...
					A2(
						$elm$core$List$map,
						function (weaponLine) {
							return A4($author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkIntersectSegSeg, enemyLine.st, enemyLine.en, weaponLine.st, weaponLine.en);
						},
						weaponLineList));
			},
			enemyLineList));
					...
					F2(
						function (weapon, cls) {
							return $author$project$SceneProtos$CoreEngine$Physics$CollisionGC$chkCollisionEnemyWeapon(
								_Utils_Tuple3(env, enemy.data, weapon.data)) ? _Utils_ap(
								_List_fromArray(
									[
										_Utils_Tuple2(
										$author$project$SceneProtos$CoreEngine$GameComponent$Base$GCById(enemy.data.uid),
	...
	function (env, objs) {
		...
		var rweapon = A2(
			...
			function (obj) {
				...
				if (_v4.$ === 'GCWeaponModel') {
					var model = _v4.a;
					return _Utils_eq(model.atkType, $author$project$SceneProtos$CoreEngine$GameComponents$Weapon$Base$Saber) && (_Utils_cmp(
						env.t - model.lastAtkTime,
						$elm$core$Basics$round(model.atkInterval / 2.5)) < 0);
				} else {
					return false;
				}
			},
...
var $author$project$SceneProtos$CoreEngine$GameComponent$Handler$recBody = {clean: $author$project$Lib$Env$Env$cleanEnvC, match: $author$project$SceneProtos$CoreEngine$GameComponent$Handler$match, _super: $author$project$SceneProtos$CoreEngine$GameComponent$Handler$super, update: $author$project$SceneProtos$CoreEngine$GameComponent$Handler$update, updaterec: $author$project$SceneProtos$CoreEngine$GameComponent$Handler$updaterec};
var $cometia0$messenger_core$Messenger$RecursionList$updateRemain = F4(
...
var $cometia0$messenger_core$Messenger$RecursionList$updateObjectsWithTarget = F4(
...
var $cometia0$messenger_core$Messenger$RecursionList$updateOnce = F3(
...
var $cometia0$messenger_core$Messenger$RecursionList$updateObjects = F3(
	function (rec, env, objs) {
...
var $author$project$SceneProtos$CoreEngine$GameComponent$Handler$updateGC = F2(
	function (env, xs) {
		var _v0 = A3($cometia0$messenger_core$Messenger$RecursionList$updateObjects, $author$project$SceneProtos$CoreEngine$GameComponent$Handler$recBody, env, xs);
		var newGC = _v0.a;
		var newMsg = _v0.b;
		var newEnv = _v0.c;
...
var $author$project$SceneProtos$CoreEngine$GameLayer$Model$updateInstruction = function (env) {
	...
	return A2(
		$elm$core$Maybe$withDefault,
		false,
		A2($elm$core$Array$get, $author$project$Lib$Tools$KeyCode$enter, env.globalData.keyList)) ? _Utils_update(
		env,
		{commonData: nc}) : env;
};
...
var $author$project$SceneProtos$CoreEngine$GameLayer$Model$displayInstruction = function (env) {
	return A5(
		...
		_List_fromArray(
			[
				$linsyking$elm_canvas$Canvas$Settings$Advanced$alpha(env.commonData.instruction / 100)
			]),
		_Utils_Tuple2(0, 0),
		_Utils_Tuple2(1920, 1080),
		'instruction');
...
var $cometia0$messenger_core$Messenger$GeneralModel$viewModelList = F2(
	function (env, models) {
		return A2(
			$elm$core$List$map,
			function (model) {
			...
			A2(
				...
				A2(
					...
					$elm$core$List$concat(
						A2($cometia0$messenger_core$Messenger$GeneralModel$viewModelList, env, xs)))));
	});
	...
	function (env, model) {
		return A2(
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						$author$project$SceneProtos$CoreEngine$GameLayer$Model$displayInstruction(env)
					])));
	});
...
var $author$project$Lib$Layer$LayerHandler$recBody = {clean: $author$project$Lib$Env$Env$cleanEnvC, match: $author$project$Lib$Layer$LayerHandler$match, _super: $author$project$Lib$Layer$LayerHandler$super, update: $author$project$Lib$Layer$LayerHandler$update, updaterec: $author$project$Lib$Layer$LayerHandler$updaterec};
...
var $author$project$Lib$Layer$LayerHandler$viewLayer = F2(
	function (env, models) {
		return A2(
			$linsyking$elm_canvas$Canvas$group,
			_List_Nil,
			A2($cometia0$messenger_core$Messenger$GeneralModel$viewModelList, env, models));
	});
...
var $author$project$Scenes$Logo$Model$updateModel = F2(
	function (env, model) {
		var changeScene = (env.t > 180) ? _List_fromArray(
			[
	...
	function (env, _v0) {
		...
		var alv = A2(
			...
			A2(
				$elm$core$Basics$min,
				1,
				(env.t < 60) ? (t / 60) : ((env.t > 120) ? ((180 - t) / 60) : 1)));
		return A2(
			$linsyking$elm_canvas$Canvas$group,
			_List_Nil,
			_List_fromArray(
...
var $author$project$SceneProtos$CoreEngine$Common$nullModel = {commonData: $author$project$SceneProtos$CoreEngine$LayerBase$nullCommonData, layers: _List_Nil};
...
var $author$project$Lib$Resources$Sprites$allTexture = _List_fromArray(
	[
		...
		_Utils_Tuple2(
		'button_resume_0',
		$author$project$Lib$Resources$Sprites$getResourcePath('img/button_resume_0.png')),
		_Utils_Tuple2(
		'button_resume_1',
		$author$project$Lib$Resources$Sprites$getResourcePath('img/button_resume_1.png')),
		_Utils_Tuple2(
		'button_quit_0',
		$author$project$Lib$Resources$Sprites$getResourcePath('img/button_quit_0.png')),
		_Utils_Tuple2(
		'button_quit_1',
		$author$project$Lib$Resources$Sprites$getResourcePath('img/button_quit_1.png')),
		_Utils_Tuple2(
		'enemy_1',
		...
		_Utils_Tuple2(
		'instruction',
		$author$project$Lib$Resources$Sprites$getResourcePath('img/instruction.png')),
		_Utils_Tuple2(
		'key_r',
		$author$project$Lib$Resources$Sprites$getResourcePath('img/keys/key_r.png')),
		_Utils_Tuple2(
		'press_enter_to_skip',
		$author$project$Lib$Resources$Sprites$getResourcePath('img/press_enter_to_skip.png')),
		_Utils_Tuple2(
		'hp_bar',
		$author$project$Lib$Resources$Sprites$getResourcePath('img/hp_bar.png'))
	]);
	...
	function (msg, model) {
		if (_Utils_cmp(
			$elm$core$List$length(
				$elm$core$Dict$keys(model.currentGlobalData.internalData.sprites)),
			...
			var timeUpdatedModel = function () {
				if (msg.$ === 'Tick') {
					return _Utils_update(
						model,
						{currentGlobalData: newGD1, time: model.time + 1});
				} else {
					return _Utils_update(
						model,
						{currentGlobalData: newGD1});
				}
			}();
			...
			var newmodel2 = function () {
				...
				if (_v7.$ === 'Just') {
					...
					var d = _v9.a;
					var n = _v9.b;
					return _Utils_eq(trans.currentTransition, trans.outT) ? $author$project$Common$resetSceneStartTime(
			...
			return _Utils_Tuple3(
				newmodel2,
				$elm$core$Platform$Cmd$batch(
					(!_Utils_eq(newmodel2.currentGlobalData.localStorage, oldLocalStorage)) ? A2(
						$elm$core$List$cons,
				...
				case 'MouseDown':
					...
					return A2(
						...
						A2(
							$author$project$Base$MouseDown,
							e,
							A2($author$project$Lib$Coordinate$Coordinates$fromMouseToVirtual, model.currentGlobalData, pos)),
						model);
				case 'MouseUp':
					var pos = msg.a;
					return A2(
						...
						if (trans.$ === 'Just') {
							...
							return (_Utils_cmp(data.currentTransition, data.inT + data.outT) > -1) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
								_Utils_Tuple2(
									_Utils_update(
										data,
										{currentTransition: data.currentTransition + 1}),
									sd));
						} else {
							return trans;
						}
...
var $author$project$Lib$Scene$Transition$makeTransition = F3(
	function (gd, trans, ren) {
		if (trans.$ === 'Just') {
			var data = trans.a;
			return (_Utils_cmp(data.currentTransition, data.outT) < 0) ? A3(data.fadeout, gd, ren, data.currentTransition / data.outT) : ((_Utils_cmp(data.currentTransition, data.outT + data.inT) < 0) ? A3(data.fadein, gd, ren, (data.currentTransition - data.outT) / data.inT) : ren);
		} else {
			return ren;
		}
	});
